...
<body class="is-preload">
			...
			<tr style="background:mistyrose" >
			 ...
			 <tr>       
               <form name="frm_order_all_cart">
					...
					<td><input type="checkbox" name="checked_goods" id="checked_goods1" checked  value="${item.goods_id }"  onClick="calcGoodsPrice(${item.goods_sales_price },this)">
					<label for="checked_goods1">${cart_id }</label> 
					</td>
    ...
    <br><br>	
		 ...
		 <button class="button primary" onclick="javascript:fn_order_all_cart_goods()">주문</button>
...
//		alert("모두 주문하기");
		...
		var length=objForm.cart_goods_qty;
